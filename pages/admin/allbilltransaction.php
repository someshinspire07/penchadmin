...
$billid = $_GET['id'];
$selectquery = "select * from transaction_data where bill_id = '$billid'";
...
<body>
  ...
  <div class="container detail mt-4">
    <div class="d-flex justify-content-between">
      ...
      <a href="farmer_data.php"><button type="button" onclick="history.back();" class="btn btn-secondary mb-2 ">
