...
$selectquery = "select * from bill_data where farmeruniqueid = '$farmerid' && status = 'PENDING'";
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a class="btn btn-info buton" href="pending_bill.php?id=<?php echo $res['bill_id']; ?>" data-toggle="tooltip" data-placement="top" title="Your Bill" role="button">Pay</a>
            </td>
          </tr>
        <?php
        }
