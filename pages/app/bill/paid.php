...
$selectquery = "select * from bill_data where farmeruniqueid = '$farmerid' && status = 'PAID'";
...
<body>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a class="btn btn-info buton" href="receipt.php?id=<?php echo $res['bill_id']; ?>" data-toggle="tooltip" data-placement="top" title="Your Receipt" role="button">View</a>
            </td>
          </tr>
        <?php
        }
  ...
  <script>
    function myFunction() {
      ...
      window.history.replaceState(null, null, "../cards/cards.php");
      location.reload();
