...
<body>
  ...
  <div class="page-content container mt-2 mb-2">
          ...
          <div class="row">
            ...
            <div class="col-30">
              <div class="text-left text-150">
                <img src="../../../img/logo1.png" height="10%" ; width="10%" ; align="left" ;>
            ...
            <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
              ...
              <div class="text-grey-m2">
                ...
                <div class="my-2">
                  ...
                  <!-- <div class="my-2">
                  <i class="fa fa-circle text-blue-m2 text-xs mr-1"></i>
                  <span class="text-600 text-90">Total Areas: </span><?php echo $arrdata['totalarea']; ?>
                </div> -->
                </div>
                <div class="my-2">
                  <i class="fa fa-circle text-blue-m2 text-xs mr-1"></i>
    ...
    if ($arrdata['pending_amount'] == $arrdata['total_amount']) {
    ?>
  ...
  if ($arrdata['pending_amount'] ==  $arrdata['total_amount']) {
  ?>
    <div class="col-1 mb-1 d-none d-lg-block" style="margin : auto;" onclick="window.print()">
  ...
  <script>
    document.getElementById('payable_amount').defaultValue = '<?php echo $arrdata['total_amount']; ?>';
    amount = document.getElementById('payable_amount').defaultValue;

    let total_amount = '<?php echo $arrdata['total_amount']; ?>'
    var options = {
      ...
      "handler": function(response) {
        $.post('paymentAPI.php', {
          ...
          amount: amount,
          pending_amount: total_amount - amount,
        }, function(data) {
    ...
    function change() {
      ...
      if (Number(amount) > Number(document.getElementById('payable_amount').defaultValue)) {
        document.getElementById('payable_amount').value = '<?php echo $arrdata['total_amount']; ?>';
        amount = parseInt('<?php echo $arrdata['total_amount']; ?>');
      }
      if (amount == 0) {
        amount = parseInt('<?php echo $arrdata['total_amount']; ?>');
      }
