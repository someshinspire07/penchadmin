...
<body>
    ...
    <div class="page-content container mt-2 mb-2">
        <div class="container px-0">
            <div class="row ">
                <div class="col-12 col-lg-12">
                    ...
                    $transquery = "select * from transaction_data where trans_id='{$ids}'";
                    $transdata = mysqli_query($con, $transquery);
                    $transarr = mysqli_fetch_array($transdata);

                    $showquery = "select * from bill_data,farmer_data where bill_id ='{$transarr['bill_id']}'";
                  ...
                  <span class="text-600 text-90">Total Area : </span><?php echo $arrdata['totalarea']; ?>
                                    ...
                                    <div class="my-2">
                                        <i class="fa fa-circle text-blue-m2 text-xs mr-1"></i>
                                        <span class="text-600 text-90">Overall Bill: </span><span style="font-weight:900;font-family: monospace; color:#108f30"><?php echo $arrdata['status']; ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-95 col-sm-16  justify-content-right">
                            ...
                            <div>
                                <span class="text-600 text-90 text-grey-m2">Paid: </span>&#8377; <?php echo $transarr['amount_paid'] . " on " . $transarr['trans_date'] . ", " . $transarr['trans_time'] . " " . "[" . $transarr['mode'] . "]"; ?>
                            </div>
                            <div>
                                <span class="text-600 text-90 text-grey-m2">Transaction ID: </span><?php echo $transarr['trans_id']; ?>
                            </div>
                ...
                <div class="row mt-1">
                    <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                        <div class="row align-items-center bgc-primary-l3 p-2">
                            <div class="col-7 text-right">Total Bill Amount</div>
                            <div class="col-5 ">
                        ...
                        <div class="row align-items-center bgc-primary-l3 p-2">
                            <div class="col-7 text-right">Pending Amount On Date <?php echo $transarr['trans_date'] ?></div>
                            <div class="col-5 ">
                                <span class="text-150 text-success-d3 opacity-2">&#8377;<?php echo $transarr['amt_pndng_on_date']; ?>
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container d-flex">
            <a href="#" class="btn btn-success btn-bold px-2 float-right mt-0.5 mt-lg-0" style="margin-left: 10px;margin-right:8px;">Paid: <?php echo $transarr['amount_paid']; ?> &nbsp; <i class="fa-solid fa-check-double"></i></a>
    ...
    <div class="col-1 mb-1 none" style="margin : auto;" onclick="window.print()">
